...
const float MINAREARATE_ARMER=1.1;//最小外接矩形与轮廓的面积比值在一定范围内
const float MAXAREARATE_ARMER=1.8;
const float MINLENTHRATE_ARMER=1;//长宽比大于一定值
const float MAXLENTHRATE_ARMER=2;//长宽比小于一定值
